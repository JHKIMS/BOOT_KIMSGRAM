	...
	<div class="profileContainer">
		...
		<div class="profile-right">
			<div class="name-group">
				...
				<c:choose>
					<c:when test="${profileDto.pageOwnerState}">
	...
	<div class="profileContainer">
		...
		<div id="tab-1-content" class="tab-content-item show">
			...
			<div class="tab-1-content-inner">
				...
				<!--아이템들-->
				<c:forEach var="image" items="${profileDto.user.images}">
				<div class="img-box">
	...
	<div class="subscribe">
		...
		<div class="subscribe-list" id="subscribeModalList">
			...
			<div class="subscribe__item" id="subscribeModalItem-2">
				...
				<div class="subscribe__btn">
					<button class="cta blue" onclick="toggleSubscribeModal(this)">팔로우 취소</button>
				</div>
			</div>
		</div>
	</div>
